Welcome to the Gemstone Menu! If you'd like to join our discord server the link is: [Gemstone](https://discord.gg/MJRQDVAZZF). If you would like the source code, the source is in [here](https://github.com/Lexiii-1/Gemstone/tree/main/Src/Gemstone) so you can check to make sure it's not a virus. Thank you for reading, and I hope to whoever is reading has a wonderful day!
